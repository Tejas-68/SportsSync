...
public class AttendanceRequestAdapter extends RecyclerView.Adapter<AttendanceRequestAdapter.ViewHolder> {

    private List<AttendanceRequest> requests;
    private OnActionClickListener listener;

    public interface OnActionClickListener {
        void onApprove(AttendanceRequest request);
        void onReject(AttendanceRequest request);
    }

    public AttendanceRequestAdapter(List<AttendanceRequest> requests, OnActionClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.tvUucmsId.setText(request.getUucmsId());
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            tvUucmsId = itemView.findViewById(R.id.tvUucmsId);
